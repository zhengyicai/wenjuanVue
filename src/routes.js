...
let routes = [
    ...
    //{ path: '/main', component: Main },
    {
        ...
        children: [
            ...
            { path: '/questions',component: resolve => require(['./views/desktop/Questions.vue'], resolve), name: '题目管理' },
            { path: '/tableTest', component: TableTest, name: '列表测试' },
            { path: '/form', component: Form, name: 'Form' },
            { path: '/user', component: user, name: '列表' },
            { path: '/sysResident',component: resolve => require(['./views/desktop/SysResident.vue'], resolve), name: '患者管理' },
            { path: '/sysResidentAnswer',component: resolve => require(['./views/desktop/SysResidentAnswer.vue'], resolve), name: '问卷管理' },
        ]
    },
    {
        path: '/',
