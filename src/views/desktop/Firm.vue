<template> 
 <div class="block">   
		...
		<el-table :data="datalist" highlight-current-row v-loading="listLoading" style="width: 100%;">
			...
			<el-table-column prop="loginName" label="用户名" width="150" sortable>
			</el-table-column>
        ...
        <el-dialog   :title="formtitle" :visible.sync="dialogFormVisible" >
			<el-form ref="subData" :model="subData" label-width="100px" @submit.prevent="onSubmit" style="margin:20px;">
                    ...
                    <el-form-item label="*用户名">
                        <el-input v-model="subData.loginName"  placeholder="请输入用户名"></el-input>
                    </el-form-item>
                    <el-form-item label="*密码">
                      <el-input v-bind:disabled="isEdit" v-model="subData.password"  placeholder="请输入密码"></el-input>
                    </el-form-item>
                     <el-form-item label="*厂商编号" style="display:none">
    ...
    methods: {
      ...
      open(){
          if(this.formtitle == '新增代理商'){
              ...
              this.subData.userName = this.subData.loginName;  
